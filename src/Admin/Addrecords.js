            ...
            <div className="col-md-10">
                ...
                <div className="row justify-content-center">
                    <div className="col-md-4 p-4 bg-light shadow">
                        ...
                        className="form-control" name="name" value={course?.name} onChange={InputHandler}></input>
                        </div>

                        <div className="mb-3">
                        <input type="text" placeholder="Enter Course Fee " 
                        className="form-control" name="fee" value={course?.fee} onChange={InputHandler}></input>
                        </div>

                        <div className="mb-3">
                        <input type="text" placeholder="Enter Course Duration " 
                        className="form-control" name="duration" value={course?.duration} onChange={InputHandler}></input>
                        </div>

                        <div className="mb-3">
                        <input type="text" placeholder="Course Faculty " 
                        className="form-control" name="faculty" value={course?.faculty} onChange={InputHandler}></input>
                        </div>
